...
from flask.ext.admin.contrib.sqla import ModelView as _SqlModelsView
...
class ModelView(_ModelView, DealsMixin):
	...
	list_template = 'mongo/list.html'
	create_template = 'mongo/create.html'
	edit_template = 'mongo/edit.html'
	detail_template = 'mongo/detail.html'
...
class SqlModelsView(_SqlModelsView, DealsMixin):
	...
	def __init__(self, model, session,
		...
		super(SqlModelsView, self).__init__(
			model,
			session,
			name=name,
			category=category,
