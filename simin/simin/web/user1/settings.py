def set_default_settings(user_manager, app_config):
	...
	um.enable_login_without_confirm_email = sd('USER_ENABLE_LOGIN_WITHOUT_CONFIRM_EMAIL', True)
	...
	um.email_token_time_limit = sd('EMAIL_TOKEN_TIME_LIMIT',  86400 * 3)
	...
	um.confirm_email_url		= sd('USER_CONFIRM_EMAIL_URL',		'/user/confirm-email/')
	...
	um.change_password_template	= sd('USER_CHANGE_PASSWORD_TEMPLATE','simin_user/change_password.html')
	um.change_username_template	= sd('USER_CHANGE_USERNAME_TEMPLATE','simin_user/change_username.html')
	um.forgot_password_template	= sd('USER_FORGOT_PASSWORD_TEMPLATE','simin_user/forgot_password.html')
	um.login_template				= sd('USER_LOGIN_TEMPLATE',			'simin_user/login.html')
	um.manage_emails_template		= sd('USER_MANAGE_EMAILS_TEMPLATE',	'simin_user/manage_emails.html')
	um.register_template			= sd('USER_REGISTER_TEMPLATE',		 'simin_user/register.html')
	um.resend_confirm_email_template = sd('USER_RESEND_CONFIRM_EMAIL_TEMPLATE', 'simin_user/resend_confirm_email.html')
	um.reset_password_template	= sd('USER_RESET_PASSWORD_TEMPLATE', 'simin_user/reset_password.html')
	um.user_profile_template		= sd('USER_PROFILE_TEMPLATE',		'simin_user/user_profile.html')

	# Set default email template files
	um.confirm_email_email_template	= sd('USER_CONFIRM_EMAIL_EMAIL_TEMPLATE',	'simin_user/emails/confirm_email')
	um.forgot_password_email_template= sd('USER_FORGOT_PASSWORD_EMAIL_TEMPLATE','simin_user/emails/forgot_password')
	um.password_changed_email_template = sd('USER_PASSWORD_CHANGED_EMAIL_TEMPLATE', 'simin_user/emails/password_changed')
	um.registered_email_template	= sd('USER_REGISTERED_EMAIL_TEMPLATE',	 'simin_user/emails/registered')
	um.username_changed_email_template = sd('USER_USERNAME_CHANGED_EMAIL_TEMPLATE', 'simin_user/emails/username_changed')